...
Blokování hnoje na webu - přepisuje jména politiků na jejich přezdívky, aby vám při čtení Novinek nestoupal tlak...
...
Rozšíření se skládá ze tří částí - Background skript (běží od startu prohlížeče, uchovává trie a data), Content skript (per-page, má přístup k DOMu) a Popup (konfigurace). Mezi sebou komunikují pomocí zpráv (Popup -> Content -> Background), oba mají oddělené kontexty.
